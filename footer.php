                                    ...
                                    <div class="footer__details">
                                        ...
                                        <div class="single__footer__address">
                                            ...
                                            <div class="footer__address">
                                                <p>4 Imperial Place Maxwell Road, Borehamwood,</p>
                                        ...
                                        <div class="single__footer__address">
                                            ...
                                            <div class="footer__address">
                                                <p><a href="mailto:enquiry@ebonyandivorycareservice.com" target="_top" style="font-size:14px;">enquiry@ebonyandivorycareservice.com</a></p>
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                                <div class="single__footer__widget our--links">
                                    ...
                                    <ul class="footer-menu">
                                        <li><a href="<?php echo get_theme_file_uri('/about')?>"><i class="zmdi zmdi-caret-right"></i>About Us</a></li>
                                        <li><a href="<?php echo get_theme_file_uri('/services')?>"><i class="zmdi zmdi-caret-right"></i>Our Services</a></li>
                                        <li><a href="<?php echo get_theme_file_uri('/join-us')?>"><i class="zmdi zmdi-caret-right"></i>Join Us</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!--End Single Footer wrap -->
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                                <div class="single__footer__widget useful--links">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li><a href="<?php echo site_url('terms')?>"><i class="zmdi zmdi-caret-right"></i>Terms of Services</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!--End Single Footer wrap -->
                        ...
                        <div class="col-md-12">
                            <div class="footer__bottom">
                                <div class="ft__btm__inner">
                                    ...
                                    <p>Copyright © 2021 <a href="#">Ebony and Ivory Care Services. </a>All Right Reserved.</p>
                                </div>
                                <ul class="ft__btm__social__icon">
                                    <li><a href="https://dribbble.com/devitemsllc"><i class="zmdi zmdi-dribbble"></i></a></li>
                                    ...
                                    <li><a href="https://www.instagram.com/devitems/"><i class="zmdi zmdi-instagram"></i></a></li>
