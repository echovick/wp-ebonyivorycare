                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12">
                                    <div class="logo">
                                        <a href="<?php echo site_url()?>"><img
                                                src="<?php echo get_theme_file_uri('/images/Ebony and Ivory Logoset with tagline.png')?>"
                                                alt="logo" class="logo-style" style=""></a>
                ...
                <div class="mobile-menu-area hidden-md hidden-lg hidden-sm" style="padding-top:3% !important;">
                    <div class="fluid-container mobile-menu-container" style="padding:5% 0% 3% 0% !important;">
                        <div class="mobile-logo">
                            <a href="index.html">
                                <img src="<?php echo get_theme_file_uri('/images/Ebony and Ivory Logoset with tagline.png')?>" class="logo-style" style="width:500px !important;" alt="Mobile logo">
                            </a>
                        </div>
